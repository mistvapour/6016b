...
def generate_plantuml_image_post(plantuml_text, output_file):
    """使用POST接口生成PlantUML图片"""
...
def main():
    ...
    for i, (name, content) in enumerate(plantuml_contents.items(), 1):
        ...
        # 生成图片
        if generate_plantuml_image_post(content, output_file):
            success_count += 1
